...
- [ ] **1. Module scaffold + types.** Create `src/router.ts` exporting the interfaces `RouterPlugin`, `RoutingContext`, `RouteDecision`, `RouterInitContext` exactly as specified above. No wiring yet. Build passes.
