 ...
 * to subscribers.
 */
export type HookEvent = 'PreToolUse' | 'PostToolUse' | 'SessionStart' | 'SessionEnd' | 'Stop' | 'Setup' | 'Notification' | 'SubagentStart' | 'SubagentEnd' | 'PreCompact' | 'PostCompact' | 'McpServerStart' | 'McpServerStop' | 'PluginStart' | 'PluginStop';
/**
